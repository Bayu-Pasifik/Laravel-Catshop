            ...
            <div class="content">
                ...
                <div class="form-login">
                    <form action="transaction-proses.php" method="post">
                        ...
                        <input class="input" type="text" name="jenis" id="jenis" placeholder="Jenis" value="" />
                        <label for="harga">Harga</label>
                        <input class="input" type="text" name="harga" id="harga" placeholder="Harga" value="" />
                        <label for="tgl">Tanggal</label>
                        <input class="input" type="date" name="tgl" id="tgl" style="margin-bottom: 20px" value="" />
